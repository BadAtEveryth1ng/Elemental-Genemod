...
class TestCatConstraint(unittest.TestCase):
    ...
    def test_status_history(self):
        ...
        for old_rank, new_rank in permutations(ranks, 2):
            ...
            if not (old_rank.is_any_clancat_rank() ^ new_rank.is_any_clancat_rank()):
                ...
                add_to_clan(cat, game.clan.group_ID)
                add_dependents_to_clan(cat, game.clan.group_ID)
                cat.rank_change(new_rank=new_rank)
            else:
                raise Exception(
    ...
    def test_gender(self):
        male = cat_factory.create_cat(genderalign="tom")
        female = cat_factory.create_cat(genderalign="molly")
