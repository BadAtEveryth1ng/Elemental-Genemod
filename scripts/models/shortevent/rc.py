...
class RC(BaseModel):
    ...
    group: Union[List[Group], MISSING] = Field(
        MISSING,
        description='List of groups r_c can belong to. Defaults to "player_clan".',
    )
    ...
    element: Union[List[Element], MISSING] = Field(
        MISSING, description="m_c will have or lack these elements."
    )
